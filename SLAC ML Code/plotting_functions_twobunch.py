...
def preset_plot_2bunch_prediction_vs_lucretia(curprof,predicted_curprof,Imax,ns):
    import matplotlib.pyplot as plt
    import numpy as np
    ns = int(ns)
    print(ns)
...
def comparison_plot_2bunch_prediction_vs_lucretia(curprof,predicted_curprof,Imax,ns):
    import matplotlib.pyplot as plt
    import numpy as np
    ns = int(ns)
    print(ns)
    ...
    plt.legend()
    plt.show()
    return ns, tvector, curprof[ns,:], predicted_curprof[ns,:]
def optimization_plot_2bunch_prediction_vs_lucretia(curprof,predicted_curprof,Imax,ns):
    import matplotlib.pyplot as plt
    import numpy as np
    ns = int(ns)
    print(ns)
    ...
    #ns = int(curprof[:,0].shape+curprof[:,0].shape*(0.5*(2*np.random.rand(1,1))-1))
    plt.figure()
    plt.plot(tvector,curprof[ns,:]*Imax,label='Neural Net');
    plt.plot(tvector,predicted_curprof[0,:]* Imax,'r--',label='Optimizer Result');
    plt.xlabel('z [um]')
    plt.ylabel('I [kA]')
    plt.legend()
    plt.show()
def optimizationv2_plot_2bunch_prediction_vs_lucretia(curprof,predicted_curprof,Imax,ns):
    import matplotlib.pyplot as plt
    import numpy as np
    ns = int(ns)
    print(ns)
    ...
    plt.figure()
    plt.plot(tvector,curprof[ns,:]*Imax,label='Neural Net');
    plt.plot(tvector,predicted_curprof[0,:]* Imax,'r--',label='Prediction');
    plt.xlabel('z [um]')
    plt.ylabel('I [kA]')
    plt.legend()
    plt.show()

def currprof(curprof,Imax,ns):
    import matplotlib.pyplot as plt
    import numpy as np
    ns = int(ns)
    print(ns)
    ...
    #ns = int(curprof[:,0].shape+curprof[:,0].shape*(0.5*(2*np.random.rand(1,1))-1))
    plt.figure()
    plt.plot(tvector,curprof[ns,:]*Imax,);
    #plt.plot(tvector,predicted_curprof[0,:]* Imax,'r--',label='Prediction');
    plt.xlabel('z [um]')
    plt.ylabel('I [kA]')
    plt.legend()
