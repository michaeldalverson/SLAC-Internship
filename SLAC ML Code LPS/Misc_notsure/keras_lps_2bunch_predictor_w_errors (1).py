...
scan_date = '3_29';
#path = "/Users/cemma/Documents/Work/FACET-II/Lucretia_sims/S20_redesign_sims/Two_bunch/Scan_data_"+scan_date+"_2019/"
...
noise_values = [0.0001,0.0001,0.0001,0.0001,0.0001,0.0001,0.0001,0.0001,0.0001]
X = np.empty([nsims,9])
...
for j in range(100):
        for k in range(240):
            ...
            numer = (predict_lpstestreshaped[randsample,j,k] - lpstest[randsample,j,k])**2
            denom = (lpstest[randsample,j,k] - lpstest[:,j,k].mean())**2
