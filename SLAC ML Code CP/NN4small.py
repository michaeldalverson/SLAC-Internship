# -*- coding: utf-8 -*-
"""
Created on Tue Jul 23 15:27:04 2019
...
scandata = sio.loadmat(path+'scandata2bunch_small.mat',squeeze_me=True); 
currprofile = sio.loadmat(path+'currprofile_small.mat',squeeze_me=True); 
...
np.save('Iz_test_scaled_small',Iz_test_scaled)